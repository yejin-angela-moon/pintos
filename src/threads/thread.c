...
thread_set_priority (int new_priority)
{
  ...
  //printf("hold:? ");
  // if (thread_current()->holder == NULL) {
  if (list_empty(&thread_current()->donations) || (!list_empty(&thread_current()->donations) && new_priority > list_entry(list_begin(&thread_current()->donations), struct thread, mult_elem)->donated_priority))
...
init_thread (struct thread *t, const char *name, int priority)
{
  ...
  t->mult_elem.next = NULL;
  t->mult_elem.prev = NULL;
